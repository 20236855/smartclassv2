<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['learning:mastery:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['learning:mastery:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['learning:mastery:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['learning:mastery:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="masteryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column 
  label='权重因子明细：{"exam_score":0.4,"video_behavior":0.3,"resource_behavior":0.2,"homework_score":0.1}' align="center" prop="weightFactors" />
...
<script>
import { listMastery, getMastery, delMastery, addMastery, updateMastery } from "@/api/learning/mastery"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('learning/mastery/export', {
        ...this.queryParams

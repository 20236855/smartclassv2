<template>
  <div class="analysis-container">
    ...
    <div v-if="!filters.courseId" class="course-select-prompt">
      <i class="el-icon-warning" style="font-size: 64px; color: #e6a23c;"></i>
      <h3>请先选择课程</h3>
      <p>请在右上角的课程下拉框中选择一个课程，以查看该课程的学情分析数据</p>
    </div>
...
export default {
  ...
  computed: {
    courseName() {
      const course = this.courseOptions.find(c => c.id === this.filters.courseId)
      return course ? course.title : '未选择'
    },
    overallAverage() {
